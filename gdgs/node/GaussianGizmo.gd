# =============================================================================
# 文件：res://addons/gdgs/nodes/gizmos/GaussianGizmo.gd
# 作用：在编辑器 3D 视图中将高斯点位显示为点云可视化。
# 核心思路：从 GaussianSplatNode 读取 positions，生成点云 mesh 并绘制。
# =============================================================================
@tool
