class_name GdgsRenderingContext
extends Object
...
static func create(device_: RenderingDevice = null) -> GdgsRenderingContext:
	var context := GdgsRenderingContext.new()
...
func create_descriptor_set(descriptors: Array[Descriptor], shader: RID, descriptor_set_index: int = 0) -> RID:
